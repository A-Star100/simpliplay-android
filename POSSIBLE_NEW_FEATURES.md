...
7. <s>Make the UI more intuitive, right now it is a tiny bit clunky.</s> **UI was improved starting with the 4.7.x series of releases**
8. <s>Make sure the app properly detects which type of media was picked first out of URLs, files, and playlists (for ExoPlayer only, the others are fine).</s> **Added in the 4.8.x series of releases.**
